...
$pdf->SetFillColor(100, 0, 0, false, 0);
$pdf->SetTextColor(100, 0, 0, false, 0);
$pdf->Rect(30, 60, 20, 20, 'DF');
$pdf->Text(30, 85, 'Cyan');

$pdf->SetDrawColor(0, 50, 0, 0);
$pdf->SetFillColor(0, 100, 0, false, 0);
$pdf->SetTextColor(0, 100, 0, false, 0);
$pdf->Rect(60, 60, 20, 20, 'DF');
$pdf->Text(60, 85, 'Magenta');

$pdf->SetDrawColor(0, 0, 50, 0);
$pdf->SetFillColor(0, 0, 100, false, 0);
$pdf->SetTextColor(0, 0, 100, false, 0);
$pdf->Rect(90, 60, 20, 20, 'DF');
$pdf->Text(90, 85, 'Yellow');

$pdf->SetDrawColor(0, 0, 0, 50);
$pdf->SetFillColor(0, 0, 0, false, 100);
$pdf->SetTextColor(0, 0, 0, false, 100);
