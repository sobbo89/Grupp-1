...
// BUILD headlines
// Label
$headline = 'Fys Index (frågor 7-10)';
...
$cimgn = 'cs_fys_graph_a_'.$_GET['AnvID'].'_'.$cimgstr.'.png';
}
...
$isum[3] = 0;
// Data
$query = "SELECT c.f7, c.f8, c.f9, c.f10 FROM cstabell c".$tableinsert." WHERE c.tillfalle = ".$x.$queryinsert;
$results = mysql_unbuffered_query($query);
while($row = mysql_fetch_array($results)){
for ($z = 0; $z <= 3; $z++){
